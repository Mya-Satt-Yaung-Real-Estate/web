...
import { Calendar, User, Phone, Mail, DollarSign, MessageSquare, ArrowLeft } from 'lucide-react';
...
export default function EditAppointment() {
  ...
  const { data: appointmentData, isLoading: appointmentLoading, error: appointmentError } = useAppointment(Number(id));
  ...
  useEffect(() => {
    if (appointment && propertyListingTypes.length > 0 && timeSlots.length > 0 && !formInitializedRef.current) {
  ...
  }, [appointment, propertyListingTypes, timeSlots, form]);
  ...
  if (appointmentError) {
    return (
      <>
        <SEOHead seo={seo} path={`/appointments/edit/${id}`} />
        <div className="min-h-screen bg-gradient-to-br from-background via-background to-primary/5 pt-24 pb-12">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <Card className="backdrop-blur-sm bg-background/95">
              <CardContent className="py-12 text-center">
                <h3 className="text-lg font-semibold mb-2">{t('appointments.errorLoading') || 'Error Loading Appointment'}</h3>
                <p className="text-muted-foreground mb-4">
                  {t('appointments.errorLoadingDesc') || 'Failed to load appointment. Please try again.'}
                </p>
      ...
      <div className="min-h-screen bg-gradient-to-br from-background via-background to-primary/5 pt-24 pb-12">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground mt-1">
                  {t('appointments.editDesc') || 'Update your appointment details'}
                </p>
              </div>
            </div>
          </div>
          ...
          {isLoading ? (
            ...
            <Card className="backdrop-blur-sm bg-background/95">
              <CardHeader>
                <CardTitle className="text-xl">{t('appointments.appointmentDetails') || 'Appointment Details'}</CardTitle>
              </CardHeader>
              <CardContent className="p-8">
