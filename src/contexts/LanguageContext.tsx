...
const translations: Translations = {
  ...
  // Detail Page
  'myWantedList.detail': { en: 'Detail', mm: 'အသေးစိတ်' },
  'myWantedList.back': { en: 'Back', mm: 'နောက်သို့' },
  'myWantedList.share': { en: 'Share', mm: 'မျှဝေရန်' },
  'myWantedList.actions': { en: 'Actions', mm: 'လုပ်ဆောင်မှုများ' },
  'myWantedList.preferLocation': { en: 'Prefer Location', mm: 'နှစ်သက်သောတည်နေရာ' },
  'myWantedList.budgetRange': { en: 'Budget Range', mm: 'ဘတ်ဂျက်အကွာအဝေး' },
  'myWantedList.descriptionRequirements': { en: 'Description & Requirements', mm: 'ဖော်ပြချက်နှင့်လိုအပ်ချက်များ' },
  'myWantedList.propertyDescription': { en: 'Property Description', mm: 'အိမ်ခြံမြေဖော်ပြချက်' },
  'myWantedList.propertySpecifications': { en: 'Property Specifications', mm: 'အိမ်ခြံမြေသတ်မှတ်ချက်များ' },
  'myWantedList.bedrooms': { en: 'Bedrooms', mm: 'အိပ်ခန်းများ' },
  'myWantedList.bathrooms': { en: 'Bathrooms', mm: 'ရေချိုးခန်းများ' },
  'myWantedList.areaRange': { en: 'Area Range', mm: 'ဧရိယာအကွာအဝေး' },
  'myWantedList.propertyType': { en: 'Property Type', mm: 'အိမ်ခြံမြေအမျိုးအစား' },
  'myWantedList.additionalRequirements': { en: 'Additional Requirements', mm: 'အပိုလိုအပ်ချက်များ' },
  'myWantedList.specialRequirements': { en: 'Special Requirements', mm: 'အထူးလိုအပ်ချက်များ' },
  'myWantedList.contactInformation': { en: 'Contact Information', mm: 'ဆက်သွယ်ရေးအချက်အလက်များ' },
  'myWantedList.phone': { en: 'Phone', mm: 'ဖုန်း' },
  'myWantedList.email': { en: 'Email', mm: 'အီးမေးလ်' },
  'myWantedList.callNow': { en: 'Call Now', mm: 'ယခုခေါ်ရန်' },
  'myWantedList.errorLoadingDetail': { en: 'Failed to load wanting list details.', mm: 'လိုချင်သောစာရင်းအသေးစိတ်များကိုဖွင့်ရန်မအောင်မြင်ပါ။' },
  'myWantedList.backToList': { en: 'Back to List', mm: 'စာရင်းသို့ပြန်သွားရန်' },
  'myWantedList.noDescription': { en: 'No description provided.', mm: 'ဖော်ပြချက်မပေးထားပါ။' },
  'myWantedList.min': { en: 'Min:', mm: 'အနည်းဆုံး:' },
  'myWantedList.max': { en: 'Max:', mm: 'အများဆုံး:' },
  'myWantedList.notAvailable': { en: 'N/A', mm: 'မရှိပါ' },
  ...
  // Appointments
  'appointments.title': { en: 'Appointments', mm: 'ချိန်းဆိုမှုများ' },
  'appointments.subtitle': { en: 'Manage your property viewing appointments', mm: 'သင့်အိမ်ခြံမြေကြည့်ရှုမှုချိန်းဆိုမှုများကိုစီမံခန့်ခွဲပါ' },
  'appointments.searchPlaceholder': { en: 'Search appointments...', mm: 'ချိန်းဆိုမှုများကိုရှာဖွေရန်...' },
  'appointments.status': { en: 'Status', mm: 'အခြေအနေ' },
  'appointments.allStatus': { en: 'All Status', mm: 'အခြေအနေအားလုံး' },
  'appointments.status.pending': { en: 'Pending', mm: 'စောင့်ဆိုင်းနေသည်' },
  'appointments.status.confirmed': { en: 'Confirmed', mm: 'အတည်ပြုပြီး' },
  'appointments.status.completed': { en: 'Completed', mm: 'ပြီးဆုံးပြီ' },
  'appointments.status.cancelled': { en: 'Cancelled', mm: 'ပယ်ဖျက်ပြီး' },
  'appointments.status.rescheduled': { en: 'Rescheduled', mm: 'ပြန်လည်ချိန်းဆိုပြီး' },
  'appointments.create': { en: 'Create Appointment', mm: 'ချိန်းဆိုမှုဖန်တီးရန်' },
  'appointments.createNew': { en: 'Create New Appointment', mm: 'ချိန်းဆိုမှုအသစ်ဖန်တီးရန်' },
  'appointments.appointmentDetails': { en: 'Appointment Details', mm: 'ချိန်းဆိုမှုအသေးစိတ်' },
  'appointments.contactInfo': { en: 'Contact Information', mm: 'ဆက်သွယ်ရန်အချက်အလက်' },
  'appointments.message': { en: 'Message', mm: 'မက်ဆေ့ချ်' },
  'appointments.propertyType': { en: 'Property Type', mm: 'အိမ်ခြံမြေအမျိုးအစား' },
  'appointments.propertyAddress': { en: 'Property Address', mm: 'အိမ်ခြံမြေလိပ်စာ' },
  'appointments.preferredDate': { en: 'Preferred Date', mm: 'နှစ်သက်သောရက်' },
  'appointments.preferredTime': { en: 'Preferred Time', mm: 'နှစ်သက်သောအချိန်' },
  'appointments.contactName': { en: 'Contact Name', mm: 'ဆက်သွယ်ရန်အမည်' },
  'appointments.phoneNumber': { en: 'Phone Number', mm: 'ဖုန်းနံပါတ်' },
  'appointments.emailAddress': { en: 'Email Address', mm: 'အီးမေးလ်လိပ်စာ' },
  'appointments.advanceAmount': { en: 'Advance Amount', mm: 'ကြိုတင်ပေးချေမှု' },
  'appointments.edit': { en: 'Edit', mm: 'တည်းဖြတ်ရန်' },
  'appointments.deleteConfirm': { en: 'Delete Appointment', mm: 'ချိန်းဆိုမှုဖျက်ရန်' },
  'appointments.deleteMessage': { en: 'Are you sure you want to delete this appointment?', mm: 'ဤချိန်းဆိုမှုကိုဖျက်လိုသည်မှာ သေချာပါသလား?' },
  'appointments.noAppointments': { en: 'No Appointments', mm: 'ချိန်းဆိုမှုမရှိပါ' },
  'appointments.noAppointmentsDesc': { en: "You haven't created any appointments yet.", mm: 'သင့်မှာချိန်းဆိုမှုများမရှိသေးပါ။' },
  ...
  'appointments.update': { en: 'Update Appointment', mm: 'ချိန်းဆိုမှုကိုပြင်ဆင်ရန်' },
  'appointments.updating': { en: 'Updating...', mm: 'ပြင်ဆင်နေသည်...' },
  'appointments.updateSuccess': { en: 'Appointment updated successfully!', mm: 'ချိန်းဆိုမှုကိုအောင်မြင်စွာပြင်ဆင်ပြီးပါပြီ!' },
  'appointments.updateSuccessTitle': { en: 'Success!', mm: 'အောင်မြင်ပါပြီ!' },
  'appointments.updateError': { en: 'Failed to update appointment', mm: 'ချိန်းဆိုမှုပြင်ဆင်ရန်မအောင်မြင်ပါ' },
  'appointments.updateErrorTitle': { en: 'Error', mm: 'အမှား' },
  'appointments.editDesc': { en: 'Update your appointment details', mm: 'သင့်ချိန်းဆိုမှုအသေးစိတ်များကိုပြင်ဆင်ရန်' },
  ...
  'advertisements.title': { en: 'My Advertisements', mm: 'ကျွန်ုပ်၏ကြော်ငြာများ' },
  'advertisements.subtitle': { en: 'Manage your advertisement campaigns', mm: 'သင့်ကြော်ငြာများကိုစီမံပါ' },
  'advertisements.createNew': { en: 'Create New Advertisement', mm: 'ကြော်ငြာအသစ်ဖန်တီးရန်' },
  'advertisements.noAdvertisements': { en: 'No advertisements found', mm: 'ကြော်ငြာများမတွေ့ရပါ' },
  'advertisements.noAdvertisementsDesc': { en: 'Create your first advertisement to get started', mm: 'စတင်ရန်သင့်ပထမဆုံးကြော်ငြာကိုဖန်တီးပါ' },
  'advertisements.searchPlaceholder': { en: 'Search advertisements...', mm: 'ကြော်ငြာများရှာဖွေရန်...' },
  'advertisements.filterByStatus': { en: 'Filter by Status', mm: 'အခြေအနေဖြင့်စစ်ထုတ်ရန်' },
  'advertisements.filterByCategory': { en: 'Filter by Category', mm: 'အမျိုးအစားဖြင့်စစ်ထုတ်ရန်' },
  'advertisements.filterByPriority': { en: 'Filter by Priority', mm: 'ဦးစားပေးမှုဖြင့်စစ်ထုတ်ရန်' },
  'advertisements.allStatuses': { en: 'All Statuses', mm: 'အခြေအနေအားလုံး' },
  'advertisements.allCategories': { en: 'All Categories', mm: 'အမျိုးအစားအားလုံး' },
  'advertisements.allPriorities': { en: 'All Priorities', mm: 'ဦးစားပေးမှုအားလုံး' },
  'advertisements.pending': { en: 'Pending', mm: 'စောင့်ဆိုင်းနေဆဲ' },
  'advertisements.approved': { en: 'Approved', mm: 'အတည်ပြုပြီး' },
  'advertisements.rejected': { en: 'Rejected', mm: 'ငြင်းပယ်ပြီး' },
  'advertisements.expired': { en: 'Expired', mm: 'သက်တမ်းကုန်ပြီး' },
  'advertisements.low': { en: 'Low', mm: 'နည်း' },
  'advertisements.medium': { en: 'Medium', mm: 'အလယ်အလတ်' },
  'advertisements.high': { en: 'High', mm: 'မြင့်' },
  'advertisements.featured': { en: 'Featured', mm: 'အထူးပြုလုပ်ထား' },
  'advertisements.views': { en: 'Views', mm: 'ကြည့်ရှုမှု' },
  'advertisements.clicks': { en: 'Clicks', mm: 'နှိပ်မှု' },
  'advertisements.budget': { en: 'Budget', mm: 'ဘတ်ဂျက်' },
  'advertisements.startDate': { en: 'Start Date', mm: 'စတင်ရက်' },
  'advertisements.endDate': { en: 'End Date', mm: 'ပြီးဆုံးရက်' },
  ...
  'advertisements.edit': { en: 'Edit', mm: 'ပြင်ဆင်ရန်' },
  'advertisements.delete': { en: 'Delete', mm: 'ဖျက်ရန်' },
  'advertisements.cancel': { en: 'Cancel', mm: 'ပယ်ဖျက်ရန်' },
  'advertisements.view': { en: 'View', mm: 'ကြည့်ရှုရန်' },
  'advertisements.duplicate': { en: 'Duplicate', mm: 'ပုံတူကူးရန်' },
  'advertisements.pause': { en: 'Pause', mm: 'ရပ်နားရန်' },
  'advertisements.resume': { en: 'Resume', mm: 'ပြန်လည်စတင်ရန်' },
  'advertisements.stats': { en: 'Statistics', mm: 'စာရင်းအင်း' },
  'advertisements.totalAdvertisements': { en: 'Total Advertisements', mm: 'စုစုပေါင်းကြော်ငြာများ' },
  'advertisements.activeAdvertisements': { en: 'Active Advertisements', mm: 'တက်ကြွသောကြော်ငြာများ' },
  'advertisements.pendingAdvertisements': { en: 'Pending Advertisements', mm: 'စောင့်ဆိုင်းနေသောကြော်ငြာများ' },
  'advertisements.totalViews': { en: 'Total Views', mm: 'စုစုပေါင်းကြည့်ရှုမှု' },
  'advertisements.totalClicks': { en: 'Total Clicks', mm: 'စုစုပေါင်းနှိပ်မှု' },
  'advertisements.totalSpent': { en: 'Total Spent', mm: 'စုစုပေါင်းသုံးစွဲမှု' },
  'advertisements.loading': { en: 'Loading advertisements...', mm: 'ကြော်ငြာများဖွင့်နေသည်...' },
  'advertisements.error': { en: 'Error loading advertisements', mm: 'ကြော်ငြာများဖွင့်ရာတွင်အမှား' },
  'advertisements.retry': { en: 'Retry', mm: 'ထပ်ကြိုးစားရန်' },
  'advertisements.refresh': { en: 'Refresh', mm: 'ပြန်လည်စတင်ရန်' },
  'advertisements.clearFilters': { en: 'Clear Filters', mm: 'စစ်ထုတ်မှုများရှင်းလင်းရန်' },
  'advertisements.sortBy': { en: 'Sort by', mm: 'အလိုက်စီရန်' },
  'advertisements.sortByDate': { en: 'Date', mm: 'ရက်' },
  'advertisements.sortByStatus': { en: 'Status', mm: 'အခြေအနေ' },
  'advertisements.sortByPriority': { en: 'Priority', mm: 'ဦးစားပေးမှု' },
  'advertisements.sortByViews': { en: 'Views', mm: 'ကြည့်ရှုမှု' },
  'advertisements.sortByClicks': { en: 'Clicks', mm: 'နှိပ်မှု' },
  'advertisements.sortByBudget': { en: 'Budget', mm: 'ဘတ်ဂျက်' },
  'advertisements.sortAscending': { en: 'Ascending', mm: 'တိုးတက်သော' },
  'advertisements.sortDescending': { en: 'Descending', mm: 'လျော့ကျသော' },
  'advertisements.perPage': { en: 'Per page', mm: 'တစ်စာမျက်နှာလျှင်' },
  'advertisements.showing': { en: 'Showing', mm: 'ပြသထားသည်' },
  'advertisements.of': { en: 'of', mm: '၏' },
  'advertisements.results': { en: 'results', mm: 'ရလဒ်များ' },
  'advertisements.previous': { en: 'Previous', mm: 'အရှေ့' },
  'advertisements.next': { en: 'Next', mm: 'နောက်' },
  'advertisements.goToPage': { en: 'Go to page', mm: 'စာမျက်နှာသို့သွားရန်' },
  'advertisements.page': { en: 'Page', mm: 'စာမျက်နှာ' },
  'advertisements.draft': { en: 'Draft', mm: 'မူကြမ်း' },
  'advertisements.verificationStatus': { en: 'Verification Status', mm: 'အတည်ပြုခြင်းအခြေအနေ' },
  'advertisements.advertisement': { en: 'Advertisement', mm: 'ကြော်ငြာ' },
  'advertisements.favorites': { en: 'Favorites', mm: 'အကြိုက်ဆုံးများ' },
  'advertisements.contacts': { en: 'Contacts', mm: 'ဆက်သွယ်မှုများ' },
  'advertisements.created': { en: 'Created', mm: 'ဖန်တီးထားသည်' },
  'advertisements.viewDetails': { en: 'View Details', mm: 'ကြည့်ရှုရန်' },
  'advertisements.confirmDeleteTitle': { en: 'Confirm Delete', mm: 'ဖျက်ရန်အတည်ပြုရန်' },
  'advertisements.confirmDeleteMessage': { en: 'Are you sure you want to delete this advertisement? This action cannot be undone.', mm: 'ဤကြော်ငြာကိုဖျက်ရန်သေချာပါသလား? ဤလုပ်ဆောင်ချက်ကိုပြန်လည်ပြုလုပ်မရနိုင်ပါ။' },
  'advertisements.deleteSuccess': { en: 'Advertisement deleted successfully!', mm: 'ကြော်ငြာကိုအောင်မြင်စွာဖျက်ပြီးပါပြီ!' },
  ...
  'properties.subtitle': { en: 'Manage your property listings', mm: 'သင့်အိမ်ခြံမြေစာရင်းများကိုစီမံပါ' },
  'properties.createNew': { en: 'Create New Property', mm: 'အိမ်ခြံမြေအသစ်ဖန်တီးရန်' },
  'properties.noProperties': { en: 'No properties found', mm: 'အိမ်ခြံမြေများမတွေ့ပါ' },
  'properties.noPropertiesDesc': { en: "You haven't created any properties yet.", mm: 'သင်၏အိမ်ခြံမြေစာရင်းများမရှိသေးပါ' },
  'properties.errorDesc': { en: 'Something went wrong while loading your properties.', mm: 'သင့်အိမ်ခြံမြေများဖွင့်ရာတွင် အမှားတစ်ခုဖြစ်ပွားခဲ့သည်။' },
  'properties.viewDetails': { en: 'View Details', mm: 'အသေးစိတ်ကြည့်ရန်' },
  'properties.status': { en: 'Status', mm: 'အခြေအနေ' },
  'properties.allStatuses': { en: 'All Statuses', mm: 'အခြေအနေအားလုံး' },
  'properties.allRegions': { en: 'All Regions', mm: 'တိုင်းဒေသကြီး/ပြည်နယ် အားလုံး' },
  'properties.allTownships': { en: 'All Townships', mm: 'မြို့နယ် အားလုံး' },
  'properties.views': { en: 'Views', mm: 'ကြည့်ရှုမှု' },
  'properties.favorites': { en: 'Favorites', mm: 'အကြိုက်ဆုံး' },
  'properties.likes': { en: 'Likes', mm: 'လိုက်ခ်' },
  'properties.comments': { en: 'Comments', mm: 'မှတ်ချက်များ' },
  'properties.edit': { en: 'Edit', mm: 'တည်းဖြတ်ရန်' },
  'properties.delete': { en: 'Delete', mm: 'ဖျက်ရန်' },
  'properties.confirmDeleteTitle': { en: 'Confirm Delete', mm: 'ဖျက်ရန်အတည်ပြုရန်' },
